...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/login` | `/login` | `/(auth)/register` | `/register` | `/(tabs)/battles` | `/battles` | `/(tabs)/create` | `/create` | `/(tabs)/` | `/(tabs)` | `/(tabs)/profile` | `/profile` | `/.DS_Store`;
  // prettier-ignore
  type DynamicRoutes<T extends string> = `/profile/${SingleRoutePart<T>}`;
  // prettier-ignore
  type DynamicRouteTemplate = `/profile/[userId]`;
